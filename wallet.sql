...
INSERT INTO `users` (`name`, `email`, `password_hash`, `created_at`, `updated_at`) VALUES ('Arlo Bergstrom', 'adonis.boyer@example.org', 'b3f2ec2054fceeadca6001c9c1554a1dc88ae9a8', '1979-07-22 15:40:18', '2021-10-25 13:30:00');
INSERT INTO `users` (`name`, `email`, `password_hash`, `created_at`, `updated_at`) VALUES ('Dr. Norberto Beahan', 'qconsidine@example.net', 'a502e0a8882272818c85ee0213f2b64f24393770', '1984-01-19 11:55:30', '1979-06-15 23:45:35');
INSERT INTO `users` (`name`, `email`, `password_hash`, `created_at`, `updated_at`) VALUES ('Amiya Oberbrunner', 'dooley.hermina@example.org', '7d94e4c99af1a62ab76c9580b6c90bb1335250b6', '1995-02-27 17:34:57', '1976-08-09 07:37:37');
INSERT INTO `users` (`name`, `email`, `password_hash`, `created_at`, `updated_at`) VALUES ('Jaquelin Eichmann Sr.', 'harber.violet@example.com', '53d5129673eb3be662fa0417ffa3dbc5002807a8', '2005-04-07 10:55:29', '2001-03-11 19:34:02');
INSERT INTO `users` (`name`, `email`, `password_hash`, `created_at`, `updated_at`) VALUES ('Joaquin Nikolaus', 'carolyne.olson@example.com', 'a6f11beed505854160ac64eb7d44868806492560', '2014-12-21 08:54:18', '2018-09-13 13:13:14');
INSERT INTO `users` (`name`, `email`, `password_hash`, `created_at`, `updated_at`) VALUES ('Deonte Hansen', 'jordane.schimmel@example.com', 'ff8aa05ceb4d25343c7a5558ed5fab6443321912', '2005-05-20 21:42:59', '1978-04-02 05:36:16');
INSERT INTO `users` (`name`, `email`, `password_hash`, `created_at`, `updated_at`) VALUES ('Merl Strosin', 'shanahan.alaina@example.net', 'cfc27977befd792b767489cac0fa3fff72d022da', '1976-05-02 02:39:52', '1993-02-05 16:23:04');
