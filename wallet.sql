...
-- Выборка кусов валют с названиями
SELECT
	c.name 'Криптовалюта',
...
CREATE TABLE `user_wallet` (
	...
	`currency_id` BIGINT UNSIGNED NOT NULL,
	`balance` FLOAT(9,8) NOT NULL DEFAULT 0,
...
-- Выборка баланса пользователя по курсу в USD
SELECT
	u.name 'Пользователь',
	FORMAT(uw.balance, 8) 'Баланс BTC',
	uw.balance * er.exchange_rate 'Баланс USD'
FROM
	users u
