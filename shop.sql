...
-- ЗАДАНИЕ 1 Создайте таблицу logs типа Archive. Пусть при каждом создании записи в таблицах users, catalogs и products в таблицу 
...
DROP TRIGGER IF EXISTS insert_in_logs;

CREATE TRIGGER insert_in_logs AFTER
INSERT
